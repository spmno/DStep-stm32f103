...
typedef enum
{
  LS_DISABLED = 0,    /*!< Low side signals and enabling signals always off.
                           It is equivalent to DISABLED. */
  LS_PWM_TIMER = !0,  /*!< Low side PWM signals are generated by timer. It is
                           equivalent to ENABLED. */
  ES_GPIO = 2         /*!< Enabling signals are managed by GPIOs (L6230 mode).*/
