/**
  ******************************************************************************
  * @file    R3_4_F30X_PWMnCurrFdbkClass.h
...
#ifndef __R3_4_F30X_PWMNCURRFDBKCLASS_H
#define __R3_4_F30X_PWMNCURRFDBKCLASS_H
...
/** @defgroup R3_4_F30X_class_exported_types R3_4_F30X class exported types
* @{
*/

/** 
  * @brief  Public R3_4_F30X class definition
  */
typedef struct CR3_4_F30X_PWMC_t *CR3_4_F30X_PWMC;

/** 
  * @brief  R3_4_F30X class parameters definition
  */
...
/* Second OPAMP settings -----------------------------------------------------*/
  uint32_t wOPAMP2_Selection;         /*!< Second OPAMP selection. It must be 
                                           either equal to 
  ...
  uint32_t wOPAMP2_NonInvertingInput_PHB; /*!< 2nd OPAMP non inverting input 
                                           ...
                                           Note: It must be the same PIN of 
                                           wOPAMP_NonInvertingInput_PHB.*/
  GPIO_TypeDef* hOPAMP2_NonInvertingInput_PHB_GPIO_PORT; 
                                      /*!< Second OPAMP non inverting input GPIO
                                           port as defined in 
                                           wOPAMP2_NonInvertingInput_PHB. 
                                           It must be GPIOx x= A, B, ...*/
  uint16_t hOPAMP2_NonInvertingInput_PHB_GPIO_PIN;
                                      /*!< Second OPAMP non inverting input GPIO
                                           pin as defined in 
                                           wOPAMP2_NonInvertingInput_PHB. 
                                           It must be GPIO_Pin_x x= 0, 1, ...*/
  ...
  uint16_t hOPAMP2_NonInvertingInput_PHC_GPIO_PIN;
                                      /*!< Second OPAMP non inverting input GPIO
                                           ...
                                           wOPAMP2_NonInvertingInput_PHC. 
                                           It must be GPIO_Pin_x x= 0, 1, ...*/
  GPIO_TypeDef* hOPAMP2_Output_GPIO_PORT; 
                                      /*!< Second OPAMP output GPIO port.
                                           It must be GPIOx x= A, B, ...
                                           Note: Output pin is PA6 for OPAMP2,
                                           PB12 for OPAMP4.*/
  uint16_t hOPAMP2_Output_GPIO_PIN;
...
/** @defgroup R3_4_F30X_class_exported_methods R3_4_F30X class exported 
  *           methods
  * @{
  */
...
/**
  ...
  * @param  pR3_F30XParams pointer to an pR3_4_F30XParams_t parameters structure
...
#endif /*__R3_4_F30X_PWMNCURRFDBKCLASS_H*/
