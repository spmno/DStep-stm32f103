/**
  ******************************************************************************
  * @file    ICS_LM1_PWMnCurrFdbkClass.h
  * @author  STMicroelectronics - System Lab - MC Team
  * @version 4.2.0
  * @date    20-Aug-2015 18:06
  * @brief   This file contains interface of ICS_LM1 class      
  ******************************************************************************
  * @attention
  *
...
#ifndef __ICS_LM1_PWMNCURRFDBKCLASS_H
#define __ICS_LM1_PWMNCURRFDBKCLASS_H
...
/** @defgroup ICS_LM1_class_exported_types ICS_LM1_class exported types
* @{
*/

/** 
  * @brief  Public ICS_LM1 class definition
  */
typedef struct CILM1_PWMC_t *CILM1_PWMC;

/** 
  * @brief  ICS_LM1 class parameters definition
  */
...
/* Current reading A/D Conversions initialization -----------------------------*/ 
  uint8_t hIaChannel;                  /*!< ADC channel used for conversion of 
  ...
  uint8_t b_IaSamplingTime;            /*!< Sampling time used to convert hIaChannel. 
                                          ...
                                          x= 1, 7, ...*/ 
  uint8_t hIbChannel;                  /*!< ADC channel used for conversion of 
...
/* PWM Driving signals initialization ----------------------------------------*/  
  ...
  uint16_t hBKINPin;                    /*!< Emergency Stop (BKIN) GPIO input pin 
                                          (if used, after re-mapping). It must be 
                                          GPIO_Pin_x x= 0, 1, ...*/     
}ICS_LM1Params_t, *pICS_LM1Params_t;
/**
  * @}
  */

/** @defgroup ICS_LM1_class_exported_methods ICS_LM1 class exported 
  *           methods
  * @{
  */
...
#endif /*__ICS_LM1_PWMNCURRFDBKCLASS_H*/
